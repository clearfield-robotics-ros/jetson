...
def main():
    ...
    for i in range(1,11): # do 10 times
        ...
        detection.x_truth = random.uniform(1, 1000)
        detection.y_truth = random.uniform(1, 1000)

        detection.estimate = random.choice([True, False])
        detection.radius_estimate = random.uniform(1, 1000)
        detection.x_estimate = random.uniform(1, 1000)
        detection.y_estimate = random.uniform(1, 1000)
        ...
        detection.warning_delay = random.uniform(0, 1)
        detection.probe_time = random.uniform(60, 5*60)
